...
const { sequelize, Movie_Genre, Movie, Genre} = require('../models');
...
route.get('/movie_genres', (req, res) => {
    Movie_Genre.findAll()
...
route.get('/movie_genres/:id', (req, res) => {
...
route.post('/movie_genres', (req, res) => {
                    Movie_Genre.create({ 
...
route.put('/movie_genres/:id', (req, res) => {
    Movie_Genre.findOne({ where: { id: req.params.id }})
    .then( mov => {
        mov.movieID = req.body.movieID,
        mov.genreID = req.body.genreID
